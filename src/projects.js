const projects = [
  {
    ...
    img: require('./images/facebook-clone-mock-shadow.png'),
    background: '#fe4a49',
  },
  {
    ...
    icon: 'fa-github-square',
    img: require('./images/billy-the-jumper-mock-shadow.png'),
    background: '#2ab7ca',
  },
  {
    ...
    icon: 'fa-github-square',
    img: require('./images/lol-champion-db-mock-shadow.png'),
    background: '#fed766',
  },
];
